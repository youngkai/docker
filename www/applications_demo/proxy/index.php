...
define('BOOTSTRAP_PATH', APPLICATION_PATH . DIRECTORY_SEPARATOR . 'BootstrapServiceApi.php');
Yaf\Loader::import(APPLICATION_PATH . DIRECTORY_SEPARATOR . 'Init.php');   
$application = new Yaf\Application(APPLICATION_PATH . DIRECTORY_SEPARATOR . 'conf' . DIRECTORY_SEPARATOR . 'proxy.ini');
