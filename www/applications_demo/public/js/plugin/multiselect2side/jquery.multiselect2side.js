...
(function($)
{
	...
	var methods = {
			...
			return this.each(function () {
				...
				var divUpDown = 
						"<div class='ms2side__updown'>" +
							(options.isSort ? "<p class='SelSort' title='排序'>" + o.labelSort + "</p>" : '') +
							"<p class='MoveTop' title='移至顶部'>" + o.labelTop + "</p>" +
							"<p class='MoveUp' title='上移'>" + o.labelUp + "</p>" +
							"<p class='MoveDown' title='下移'>" + o.labelDown + "</p>" +
							"<p class='MoveBottom' title='移至底部'>" + o.labelBottom + "</p>" +
						"</div>";
				...
				var htmlToAdd = 
					"<div class='ms2side__div'>" +
						...
						"<div class='ms2side__options'>" +
							...
							?
							("<p class='AddOne' title='Add Selected'><i class = 'fa fa-chevron-right'></i></p>" +
							//"<p class='AddAll' title='Add All'><i class = 'fa fa-chevron-right'></i></p>" +
							//"<p class='RemoveAll' title='Remove All'><i class = 'fa fa-chevron-left'></i></p>" +
							"<p class='RemoveOne' title='Remove Selected'><i class = 'fa fa-chevron-left'></i></p>")
							:
		...
		//add @2014-02-20 by Kevin 清空列表数据
		destroyAll : function( ) {
			var el = $(this);
			var allSel = el.next().children(".ms2side__select").children("select");
			allSel.eq(0).empty();
		...
		addOption : function(options) {
			...
			return this.each(function () {
				...
				var	strEl = "<option value='" + oAddOption.value + "' " + (oAddOption.disabled ? " class='txt-color-red' disabled='disabled' " : "") + " >" + oAddOption.name + "</option>";
				//end update
				el.append(strEl);
